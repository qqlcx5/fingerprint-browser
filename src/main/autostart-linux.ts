...
export const LINUX_AUTOSTART_FILENAME = 'anta-harness.desktop'

const APP_DISPLAY_NAME = 'Anta Harness'
const APP_COMMENT = 'Automatically start Anta Harness at login'
