...
/**
 * anta-harness — CLI launcher for Anta Harness GUI
 *
 * Usage:
 *   anta-harness              # Launch the app
 *   anta-harness --help       # Show help
 *   anta-harness --version    # Show version
 *   anta-harness /path/to/dir # Launch with workspace
 */
...
if (args.includes('--help') || args.includes('-h')) {
  console.log(`
  anta-harness v${VERSION} — Desktop GUI harness for coding agents

  Usage:
    anta-harness                  Launch the app
    anta-harness <path>           Launch with workspace directory
    anta-harness --help           Show this help
    anta-harness --version        Show version

  Examples:
    anta-harness                  # Launch with default workspace
    anta-harness ~/my-project     # Launch with specific project
    anta-harness .                # Launch with current directory
...
function launch() {
  ...
  child.on('error', (err) => {
    console.error('Failed to start Anta Harness:', err.message)
    process.exit(1)
  })
