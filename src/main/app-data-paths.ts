...
export const GUI_DATA_ENV_VAR = 'ANTA_HARNESS_USER_DATA_DIR'
export const LEGACY_GUI_DATA_ENV_VAR = 'PI_DESKTOP_USER_DATA_DIR'
export const CANONICAL_GUI_DATA_DIR_NAME = 'anta-harness'
export const LEGACY_GUI_DATA_DIR_NAME = '.pi-desktop-gui'
export const LEGACY_ELECTRON_GUI_DATA_DIR_NAMES = ['pi-desktop', 'PI Desktop', 'pi-desktop-gui'] as const
...
export function getExternalGuiDataDir(env: NodeJS.ProcessEnv = process.env): string | undefined {
  const external = env[GUI_DATA_ENV_VAR] ?? env[LEGACY_GUI_DATA_ENV_VAR]
