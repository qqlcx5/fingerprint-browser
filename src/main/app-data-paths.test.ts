...
test('getCanonicalUserDataDir appends the canonical dir name', () => {
  assert.equal(getCanonicalUserDataDir('/home/test/.config'), '/home/test/.config/anta-harness')
  assert.equal(
    getCanonicalUserDataDir('/Users/test/Library/Application Support'),
    '/Users/test/Library/Application Support/anta-harness'
  )
  assert.equal(
    getCanonicalUserDataDir('C:\\Users\\test\\AppData\\Roaming'),
    'C:\\Users\\test\\AppData\\Roaming/anta-harness'
  )
})
